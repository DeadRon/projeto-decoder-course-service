...
public class CourseUserController {
    ...
    public ResponseEntity<Object> getAllUsersByCourse(SpecificationTemplate.UserSpec spec,
        ...
        Page<UserModel> userServiceAll = userService.findAll(SpecificationTemplate.userCourseId(courseId).and(spec), pageable);

        return ResponseEntity.status(HttpStatus.OK).body(userServiceAll);
    }
    ...
    public  ResponseEntity<Object> saveSubscriptionUserInCourse(@PathVariable(value = "courseId") UUID courseId,
        ...
        //Verifica se o usuário STUDENT não esta cadastrado no curso
        ...
        //verificar se usuário está Bloqueado através do userStatus
